...
#
# Generated by export_simulation on Fri Jan 05 21:21:50 +0800 2018
#
################################################################################
...
switch to the './blk_mem_gen_0_origin.sh' script.

./blk_mem_gen_0_origin.sh -reset_run
...
./blk_mem_gen_0_origin.sh -noclean_files

For more information on the script, please type './blk_mem_gen_0_origin.sh -help'.
