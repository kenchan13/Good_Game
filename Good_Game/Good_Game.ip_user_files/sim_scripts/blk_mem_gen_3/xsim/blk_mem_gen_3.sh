...
#
# Generated by Vivado on Tue Jan 02 17:03:50 +0800 2018
...
# Script info
echo -e "blk_mem_gen_3.sh - Script generated by export_simulation (Vivado v2017.2 (64-bit)-id)\n"
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L blk_mem_gen_v8_3_6 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot blk_mem_gen_3 xil_defaultlib.blk_mem_gen_3 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim blk_mem_gen_3 -key {Behavioral:sim_1:Functional:blk_mem_gen_3} -tclbatch cmd.tcl -log simulate.log
}
